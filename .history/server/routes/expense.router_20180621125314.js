...
router.post('/', (req, res, next) => {
	...
	if (req.isAuthenticated()) {
		const queryText = `INSERT INTO employment_database ("company_name", "market", "application_status", "application_date", "response_received", "phone_interview_date", "notes") VALUES ($1, $2, $3, $4, $5, $6);`;
		pool
