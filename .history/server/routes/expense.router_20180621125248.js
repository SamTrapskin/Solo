...
router.post('/', (req, res, next) => {
	...
	if (req.isAuthenticated()) {
		const queryText = `INSERT INTO employment_database ("company_name", "market", "application_status", "application_date", "response_received", "phone_interview_date", "notes") VALUES ($1, $2, $3, $4);`;
		pool
			.query(queryText, [ req.body.company_name, req.body.market, req.body.application_status, req.body.application_date, req.body.response_received, req.body.phone_interview_date, req.body.])
			.then((result) => {
				res.sendStatus(201);
			})
			.catch((err) => {
