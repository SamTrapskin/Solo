...
router.post('/', (req, res, next) => {
	...
	if (req.isAuthenticated()) {
		...
		pool
			.query(queryText, [ req.body.company_name, req.body.market, req.body.application_status, req.body.application_date, req.body.response_received, req.body.phone_interview_date])
			.then((result) => {
				res.sendStatus(201);
			})
			.catch((err) => {
